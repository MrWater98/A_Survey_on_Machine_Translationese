...
To provide a clear and structured overview of this complex, co-evolving landscape, this survey adopts a hybrid matrix structure. We first establish a unified framework in Section 2, defining the three core research tasks that form the pillars of translationese research: Characterization, Detection, and Mitigation. Following this framework, we dedicate separate sections to each of these core tasks. Within each of these thematic sections, we trace the chronological progression of research, from early corpus-based and statistical methods to the latest advancements in the era of NMT and LLMs. Specifically, Section 3 reviews the evolving \textbf{Characteristics} of translationese across different MT paradigms. Section 4 surveys the progression of \textbf{Detection} methods, from feature engineering to deep learning. Section 5 details the development of \textbf{Mitigation} strategies. Finally, Section 6 discusses broader impacts and future challenges, including model collapse and algorithmic fairness. This structure allows readers to either gain a deep understanding of a specific task (e.g., Detection) or to trace the historical development across all tasks, providing a comprehensive and accessible guide for both newcomers and experienced researchers.

\section{A Unified Framework for Translationese Research}
\subsection{Defining the Core Tasks}
\subsection{Task Relationships and Research Flow}
\subsection{Framework Overview}

\section{The Evolving Characteristics of Translationese}
\subsection{Foundational Concepts from Corpus-Based Studies}
\subsection{Interference and Artifacts in the SMT Era}
\subsection{Subtle Biases in the NMT Era}
\subsection{New Patterns in the LLM Era}

\section{The Progression of Detection Methods}
\subsection{Early Approaches: Feature Engineering}
\subsection{The Rise of Neural Classifiers}
\subsection{Recent Advances: Explainability and Zero-shot Detection}

\section{The Development of Mitigation Strategies}
\subsection{Data Filtering and Augmentation}
\subsection{Model Fine-tuning and Architectural Changes}
\subsection{Prompt Engineering and Human Feedback in LLMs}

\section{Broader Impacts and Future Challenges}
\subsection{The Risk of Model Collapse}
\subsection{Fairness, Bias, and Algorithmic Auditing}
