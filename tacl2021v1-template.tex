...
\maketitle
\begin{abstract}
  The proliferation of machine translation (MT) in global information exchange has made understanding its linguistic artifacts increasingly critical. Translated text, whether by human or machine, exhibits systematic and often subtle differences from non-translated text, a phenomenon known as ``translationese''. Consequently, researchers have been exploring the characteristics, detection, and impact of translationese using techniques from corpus linguistics, natural language processing, and machine learning. In this paper, we provide a comprehensive survey of translationese research, charting its evolution alongside major technological shifts in machine translation. We structure our review chronologically, beginning with the theoretical foundations laid by corpus-based translation studies, moving through the statistical (SMT) and neural (NMT) machine translation eras, and culminating in the recent paradigm of Large Language Models (LLMs). In this process, we present an overview of key tasks, datasets, and models, aiming to unify the various definitions of translationese and trace the development of core concepts and methodologies. Finally, we highlight pressing challenges and suggest future research directions, particularly concerning the novel forms of translationese produced by LLMs and the long-term effects of training on machine-generated text.
\end{abstract}
