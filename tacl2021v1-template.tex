...
\maketitle
\begin{abstract}
  The proliferation of machine translation (MT) has made understanding its linguistic artifacts, known as ``translationese'', increasingly critical. Researchers have explored the characteristics, detection, and impact of translationese using techniques from corpus linguistics, natural language processing, and machine learning. In this paper, we survey translationese research by charting its evolution alongside major technological shifts in MT. We structure our review chronologically, from the theoretical foundations of corpus-based studies, through the statistical (SMT) and neural (NMT) eras, to the recent paradigm of Large Language Models (LLMs). This process unifies various definitions and traces the development of core concepts. Finally, we highlight challenges for future research, particularly the novel forms of translationese in LLMs and the effects of training on machine-generated text.
\end{abstract}
